 ...
 *       &lt;sequence>
 *         &lt;element name="identifier" type="{http://api.web.bc/capability/business/b010-02/objects/responsesubmitbillingordering/flv000624/v1}BillingOrderIdentifierType" maxOccurs="100"/>
 *         &lt;element name="status" type="{http://api.web.bc/capability/business/b010-02/objects/responsesubmitbillingordering/flv000624/v1}StatusType" minOccurs="0"/>
 *         &lt;element name="salesChannelIdentifier" type="{http://api.web.bc/capability/business/b010-02/objects/responsesubmitbillingordering/flv000624/v1}SalesChannelIdentifierType" minOccurs="0"/>
 *         &lt;element name="item" type="{http://api.web.bc/capability/business/b010-02/objects/responsesubmitbillingordering/flv000624/v1}BillingOrderItemType" maxOccurs="100" minOccurs="0"/>
 *         &lt;element name="charVal" type="{http://api.web.bc/capability/business/b010-02/objects/responsesubmitbillingordering/flv000624/v1}BillingOrderCharValType" maxOccurs="100" minOccurs="0"/>
 *         &lt;element name="operationalContext" type="{http://api.web.bc/capability/business/b010-02/objects/responsesubmitbillingordering/flv000624/v1}BillingOrderOperationalContextType" minOccurs="0"/>
 *         &lt;element name="customerOrderIdentifier" type="{http://api.web.bc/capability/business/b010-02/objects/responsesubmitbillingordering/flv000624/v1}CustomerOrderIdentifierType" minOccurs="0"/>
 *         &lt;element name="customerIdentifier" type="{http://api.web.bc/capability/business/b010-02/objects/responsesubmitbillingordering/flv000624/v1}CustomerIdentifierType" minOccurs="0"/>
 *         &lt;element name="relationship" type="{http://api.web.bc/capability/business/b010-02/objects/responsesubmitbillingordering/flv000624/v1}BillingOrderRelationshipType" maxOccurs="100" minOccurs="0"/>
...
public class BillingOrderType {
    ...
    protected List<BillingOrderIdentifierType> identifier;
     ...
     * 
     */
    public List<BillingOrderIdentifierType> getIdentifier() {
        if (identifier == null) {
            identifier = new ArrayList<BillingOrderIdentifierType>();
        }
